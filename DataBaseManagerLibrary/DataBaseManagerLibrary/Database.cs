...
namespace DataBaseManagerLibrary
{
    class Database
    {
        ...
        public static Database CreateDatabaseManager(ConnectionInfo connectionInfo, Action<string> displayError)
        {
            ...
            Console.Out.Flush();
            connection.Close();
            return new Database(connection, connectionInfo, displayError);
        }

        /// <summary>
        /// Constructor that takes in an existing connection
        /// </summary>
        Database(SqlConnection connection, ConnectionInfo connectionInfo, Action<string> displayError)
        {
        ...
        /// <returns>the user ID/ -1 if connection fails</returns>
        public int SaveToDatabase(UserData gameData, bool newUser = false)
        {
            int id = gameData.Id;
